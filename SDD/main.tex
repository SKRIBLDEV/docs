...
\author{} %leave empty
\date{19 april 2015} %ok, manuele datum
...
%already long enough ;)
%Dit diagram geeft een gedetailleerde kijk op de "'User"' entiteit. deze entiteit stelt de gebruiker voor en heeft 2 unieke keys: zijn "'username"' en de "'firstName"', "'lastName"' combo die ge\"erfd wordt van "'Persons"'. Aan de hand van verzamelde informatie zal het systeem een "'suggestion"' relatie maken tussen "'User"' en "'Publications"', dit is de enige directe relatie tussen deze twee entiteiten, verdere interactie gebeurt via de "'Library"'. "'suggestions"' zal gebruikt worden om later publicaties voor te stellen aan de gebruiker. \\
